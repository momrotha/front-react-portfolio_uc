...
import cvFile from "../../assets/cv/ROTHA MOM.pdf";
        ...
        <div className="max-sm:w-full w-[33rem]">
          ...
          <div className="text-xs xs:text-[16px] lg:text-lg font-normal max-md:text-center text-gray-600">
            <p>
              ...
              applications. I focus on clean UI, usability, and performance to
              deliver meaningful digital experiences.
            </p>

            <p className="mt-3">
              Skilled in React, Tailwind CSS, JavaScript, and UX/UI design, with
              a passion for building real-world projects.
            </p>
          </div>
